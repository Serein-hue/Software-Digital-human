...
const dict: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    'guide.photo': '拍照',
    'guide.popularSpots': '热门景点',
    'guide.selectSpot': '选择景点',
    ...
    'kiosk.durationValue': '4-6 小时',
    'kiosk.ticketRef': '门票参考',
    'kiosk.ticketValue': '210 元/人',
    ...
    'dashboard.subtitle': '灵山胜境运营数据 · 实时更新',
    ...
    'admin.slices': '内容分段',
    'admin.docType': '文档类型',
    'admin.docTypeSpotData': '景点数据',
    'admin.docTypeGuide': '游览指南',
    'admin.docTypeDataset': '数据集',
    'admin.docTypeImage': '图片',
    'admin.docTypeRule': '规则',
    ...
    'admin.kbCache': '知识库缓存',
    'admin.kbCacheDesc': '知识库缓存（含向量索引和分段内容）',
  ...
  en: {
    ...
    'guide.photo': 'Camera',
    'guide.popularSpots': 'Hot Spots',
    'guide.selectSpot': 'Select a Spot',
    ...
    'kiosk.durationValue': '4-6 hours',
    'kiosk.ticketRef': 'Admission',
    'kiosk.ticketValue': '¥210',
    ...
    'admin.docType': 'Type',
    'admin.docTypeSpotData': 'Spot Data',
    'admin.docTypeGuide': 'Guide',
    'admin.docTypeDataset': 'Dataset',
    'admin.docTypeImage': 'Image',
    'admin.docTypeRule': 'Rule',
