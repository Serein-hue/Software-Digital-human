...
async def admin_auth_middleware(request: Request, call_next):
    ...
    if not auth.startswith("Bearer "):
        return JSONResponse(status_code=401, content=err(40100, "缺少 Authorization 头", trace_id))
    ...
    try:
        ...
        return JSONResponse(status_code=503, content=err(50300, "认证服务不可用", trace_id))
